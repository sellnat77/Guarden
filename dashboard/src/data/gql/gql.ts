...
const documents: Documents = {
    ...
    "\n  fragment PlantFragment on Plant {\n    id\n    name\n    species\n    image\n    generalHealth\n    lightRequirements\n    lastPruned\n    lastWatered\n    waterFrequencyDays\n    lastRepotted\n    lastFertilized\n    locationId\n    location {\n      lightProvided\n    }\n  }\n": types.PlantFragmentFragmentDoc,
    "\n  query Dashboard_getPlantsAndLocations($currentUser: Int!) {\n    plant {\n      getPlants(filters: { createdBy: $currentUser }) {\n        ...PlantFragment\n      }\n    }\n    location {\n      getLocations(filters: { createdBy: $currentUser }) {\n        id\n        name\n      }\n    }\n  }\n": types.Dashboard_GetPlantsAndLocationsDocument,
    "\n  fragment VitalDetailFragment on VitalModel {\n    date\n    healthPct\n    id\n    image\n    notes\n  }\n": types.VitalDetailFragmentFragmentDoc,
    "\n  fragment LocationDetailFragment on Location {\n    id\n    name\n    lightProvided\n  }\n": types.LocationDetailFragmentFragmentDoc,
    "\n  fragment PlantDetailFragment on Plant {\n    createdById\n    description\n    fertilizeFrequencyDays\n    generalHealth\n    id\n    image\n    lastFertilized\n    lastPruned\n    lastRepotted\n    lastWatered\n    lightRequirements\n    location {\n      ...LocationDetailFragment\n    }\n    name\n    pruneFrequencyDays\n    repotFrequencyDays\n    species\n    waterFrequencyDays\n    vitals {\n      edges {\n        node {\n          ...VitalDetailFragment\n        }\n      }\n    }\n  }\n": types.PlantDetailFragmentFragmentDoc,
