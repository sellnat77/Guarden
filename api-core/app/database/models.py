...
INITIAL_DATA = {
    ...
    "vitals": [
        ...
        # Monty (id 2) — spider mites in early 2023, slow treatment and recovery
        {
            ...
            "plantId": 2,
            "healthPct": 22,
            "date": TODAY - timedelta(days=1121),
        ...
        },
        {
            ...
            "plantId": 2,
            "healthPct": 18,
            "date": TODAY - timedelta(days=1073),
        ...
        # Sansa (id 4) — consistently healthy snake plant, minor dip in winter 2023
        {
            ...
            "plantId": 4,
            "healthPct": 88,
            "date": TODAY - timedelta(days=1070),
        ...
        # Fifi (id 5) — near death in early 2023, slow long road to recovery
        {
            ...
            "plantId": 5,
            "healthPct": 3,
            "date": TODAY - timedelta(days=1160),
        ...
        },
        {
            ...
            "plantId": 5,
            "healthPct": 9,
            "date": TODAY - timedelta(days=1088),
        ...
        # Lily (id 6) — wilting episode mid-2023, recovered to peak blooming
        {
            ...
            "plantId": 6,
            "healthPct": 33,
            "date": TODAY - timedelta(days=1030),
        ...
        # Rudy (id 7) — severe scale infestation in early 2023, treated and thriving
        {
            ...
            "plantId": 7,
            "healthPct": 14,
            "date": TODAY - timedelta(days=1107),
        ...
        },
        {
            ...
            "plantId": 7,
            "healthPct": 27,
            "date": TODAY - timedelta(days=1038),
        ...
        # Ziggy (id 8) — consistently excellent, barely any dips
        {
            ...
            "plantId": 8,
            "healthPct": 85,
            "date": TODAY - timedelta(days=1119),
        ...
        },
        {
            ...
            "plantId": 8,
            "healthPct": 88,
            "date": TODAY - timedelta(days=1005),
        ...
        },
        {
            ...
            "plantId": 9,
            "healthPct": 17,
            "date": TODAY - timedelta(days=1006),
        ...
        # Charlotte (id 10) — humidity and overwatering issues in 2023, recovered well
        {
            ...
            "plantId": 10,
            "healthPct": 26,
            "date": TODAY - timedelta(days=1146),
    ...
    "plants": [
        {
            ...
            "lastWatered": TODAY - timedelta(days=6),  # next: TODAY + 1  (freq: 7d)
        ...
        },
        {
            ...
            "lightRequirements": LightLevelsEnum.SHADY,
            "lastWatered": TODAY - timedelta(days=9),  # next: TODAY - 2  (freq: 7d)
            "waterFrequencyDays": 7,
        ...
        },
        {
            ...
            "lastWatered": TODAY - timedelta(days=8),  # next: TODAY + 2  (freq: 10d)
        ...
        },
        {
            ...
            "lastWatered": TODAY - timedelta(days=22),  # next: TODAY - 1  (freq: 21d)
        ...
        },
        {
            ...
            "lastWatered": TODAY - timedelta(days=4),  # next: TODAY + 3  (freq: 7d)
            "waterFrequencyDays": 7,
            "fertilizeFrequencyDays": 30,
            "pruneFrequencyDays": 180,
            "repotFrequencyDays": 365,
        ...
        },
        {
            ...
            "lightRequirements": LightLevelsEnum.PARTIAL,
            "lastWatered": TODAY - timedelta(days=10),  # next: TODAY - 3  (freq: 7d)
            "waterFrequencyDays": 7,
            "fertilizeFrequencyDays": 60,
            "pruneFrequencyDays": 90,
            "repotFrequencyDays": 365,
        ...
        },
        {
            ...
            "lastWatered": TODAY - timedelta(days=10),  # next: TODAY + 0  (freq: 10d)
            "waterFrequencyDays": 10,
            "fertilizeFrequencyDays": 30,
            "pruneFrequencyDays": 180,
            "repotFrequencyDays": 730,
        ...
        },
        {
            ...
            "lastWatered": TODAY - timedelta(days=19),  # next: TODAY + 2  (freq: 21d)
            "waterFrequencyDays": 21,
            "fertilizeFrequencyDays": 90,
            "pruneFrequencyDays": 365,
            "repotFrequencyDays": 730,
        ...
        },
        {
            ...
            "lastWatered": TODAY - timedelta(days=17),  # next: TODAY - 3  (freq: 14d)
